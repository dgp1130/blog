...
*   Blindly publish internal communications of moderation staff in "Twitter
    files" and allege wrongdoing when the evidence doesn't actually show that.
*   Cause several outages of varying degrees.
*   Promote "free speech" by banning Twitter accounts which he personally
    disagrees with.
*   Made major policy decisions via Twitter poll.
*   Disbanded content moderation council (and lied about it).
*   Broke Twitter verified labels multiple times.
*   Publicly harassed employees.
...
with the... _everything_ that he represents. In particular, as of today Trump
has faced little to no personal accountability for the hundreds (?) of scandals
and particularly for attempting to _overthrow the government_. As of today he is
yet to be indicted for anything and while his political power has certainly
weakened, he is still a very real contender for the 2024 presidential race.
...
I could go on, but I really don't want to and this is why I try to avoid this
stuff. So let's talk about Elon's other failures instead.
...
(how do we support and incentivize people to have positive human interactions).
...
platform accessible, supporting disadvantaged users, defining moderation
...
this key point. He always focused a lot of attention on defining content
policies, empowering moderators and building a moderation council, handling
abuse, supporting disadvantaged users, etc. It was never perfect for sure, lots
of other people were involved beyond Dorsey, and Twitter certainly made
missteps along the way. However it always came across as at least _trying_ to do
the right thing. Twitter always recognized that content moderation is
_important_ and _nuanced_, two things Elon still fails to grasp.
...
privilege I have yields a very different perspective than many other Twitter
users. Elon's interpretation of "free speech" _sounds_ great to me, someone who
never had to block anyone on Twitter. However I understand that not everyone has
my experience. I can see people who _do_ have to block others and the harm they
feel which leads to blocking. This is where policies like mass-unbanning or
"anything that's legal is allowed" cause very real harm for users.
[Mike Masnick's](https://mastodon.social/@mmasnick)
[content moderation speedrun article](https://www.techdirt.com/2022/11/02/hey-elon-let-me-help-you-speed-run-the-content-moderation-learning-curve/)
...
don't care too much about big tech CEOs. As a current Google employee I can say
that decisions Sundar Pichai makes are so far removed from what I deal with on a
day-to-day basis that I really don't care what he does and I feel similarly
about most major CEOs. I don't typically judge a company or my desire to work
there based on its CEO, but Elon (and maybe Zuckerberg) is absolutely a CEO I
would _never_ want to work for.
...
the massive amount of layoffs, churn, and general turmoil at the company? There
are already reports of
[a major hack](https://www.washingtonpost.com/politics/2023/01/05/twitters-latest-hack-is-big-one/)
leaking hundreds of millions of user's information (though in fairness it seems
to have been stolen prior Elon's takeover). Does current Twitter feel like a
safe and secure place for your information? Does Elon seem like the kind of guy
who would encourage developers to take the time to properly security review
the PR which breaks the verified checkmark?
...
Elon's takeover. It started with brining Trump back onto the platform, to being
...
and be less focused on a "topic of the day about dunking on the stupid person
doing a stupid thing." While the community is definitely smaller, I still get
about the same amount of engagement on Mastodon as I do on Twitter, and
generally higher quality in my opinion. Also, there's a solid number of people I
previously followed on Twitter whom I'm pretty sure did not follow me back, but
they've decided to follow me on Mastodon. I'm not sure how much of this is just
people becoming acquainted with the new platform and how much is a result of
distinct cultural differences, but we'll have to see how things shake out in the
future.
...
ecosystem with no clear answer.
...
future. Personally, I'd be totally fine if a server showed ads and that made
enough revenue to keep the service free, and I think the current state of
ad-funded social networks serves as an existence proof that many users are
comfortable with that as an idea. I expect that the OSS community behind
Mastodon would likely have strong philosophical objections about such an
approach. Hopefully the diversity of servers and people in this space will find
the right sustainability model for them, but I've yet to see anything which
really seems like a clear success. (All that said, please toss a coin to your
server admins.)
...
infrastructure you want to see sustainable, the maintainers you're trusting with
your security and privacy. But also the server is completely _unimportant_
because you can change it at any time, see content from any other server, host
your own server with your own rules.

There's a fundamental contradiction here about what the server _represents_ to
its community. From a practical perspective I feel like the server is mainly the
infrastructure serving my traffic and also the domain attached to my Mastodon
handle. I can't associate a name or face with my server admin because I see
Mastodon as a "global social network", but there are absolutely others who do
know their server admins and have direct conversations with them about
...
looks like a language made up from scratch for code golfing. Twitter is at the
opposite end of the spectrum where communities are much more ambiguous and
focused on individuals rather than well-defined communities.

Exactly where Mastodon fits into this spectrum is still unclear to me. That's
not necessarily a fatal or even a bad thing. Maybe we can find the best of both
...
Thirdly, I don't really see clear user-facing benefits to decentralization. This
is a bigger problem with the blockchain community, but that's a whole separate
blog post. I have a pet peeve about "decentralization" as a selling point.
**Decentralization is not a feature.** Decentralization is an architectural
choice, sell me on the features which are enabled by your decentralized
architecture. "You can pick a server with moderation policies you like" or "you
can own your server and be protected from a power-hungry admin" are features
enabled by decentralization, sell me on those, not the mythical
"decentralization" bullet point. Maybe these features are compelling to you, but
they just aren't for me.

A common phrase I can't easily attribute is "people don't want to run their own
servers." We've "solved" this problem in the past couple decades by centralizing
applications (see every other major tech company), and whatever personal
objections people have with that approach it has clearly been successful. My
favorite example of this is how decentralized email infrastructure is when 90%
of accounts are served by Gmail. Does decentralization allow Mastodon to provide
more value for users than other social networks? If there was ever a reason to
choose a decentralized social network, Twitter's implosion was it. Even this
blog was heavily inspired by
...
Twitter. I'm personally not convinced this is a significant improvement in
Mastodon's favor.
...
Despite Elon's best efforts I do think Twitter will stick around for quite a
while. It's simply too big and too ingrained in the current internet culture to
disappear overnight. Even MySpace still exists. But like MySpace, social media
networks tend not to die spectacularly, they die a death of irrelevance. They
die when the cultural conversation moves on and people stop thinking about it.
That may happen eventually to Twitter, and it will be interesting to look back
on Elon's takeover with the benefit of hindsight. Was it the start of Twitter's
death spiral? Did it save or delay Twitter's death? Was it doomed from the
start?

Will Mastodon take over? I highly doubt it. People find their communities
organically and through their existing relationship. Twitter's spiral will
...
for, and I do feel it will meet users' needs there.
...
well, so look forward to an end of year post about how I failed to do so. I also
just started a [YouTube channel](https://www.youtube.com/@develwithoutacause)
and published my first video on
[HydroActive](https://www.youtube.com/watch?v=zL0TzFY6aj0). I'm hoping to take
advantage of that channel for more cool web dev content in the future.
